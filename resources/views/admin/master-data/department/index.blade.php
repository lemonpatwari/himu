                                        ...
                                        @foreach($department as $value)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <form action="{{ route('department.destroy',$value) }}" method="post" style="overflow-y: hidden" >
                                                        @method('DELETE')
                                                        @csrf
                                                        <div class="btn-group">
                                                            <a href="{{ route('department.edit',$value) }}" class="btn btn-warning btn-sm" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
